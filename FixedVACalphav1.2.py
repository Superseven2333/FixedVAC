...
def one():
    print("正在执行方案一···")
    inp()
    os.system("sc config Netman start= AUTO")
    os.system("sc start Netman")
    os.system("sc config rasman start= AUTO")
    os.system("sc start rasman")
    os.system("sc config tapisrv start= AUTO")
    os.system("sc start tapisrv")
    os.system("sc config mpssvc start= AUTO")
    os.system("sc start mpssvc")
